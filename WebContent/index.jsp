...
<div class="slider">
	  <div class="callbacks_container">
	      <ul class="rslides" id="slider">
	        <li><img src="images/ba1.jpg" class="img-responsive" alt=""/></li>
	        <li><img src="images/ba2.jpg" class="img-responsive" alt=""/></li>
	        <li><img src="images/ba3.jpg" class="img-responsive" alt=""/></li>
	        <li><img src="images/ba4.jpg" class="img-responsive" alt=""/></li>
	      </ul>
	  </div>
</div>
...
<div class="sap_tabs">	
						 <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
						  <ul class="resp-tabs-list">
							  ...
							  <li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span>Deals</span></li>
							  <li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span>Coming Soon</span></li>
       ...
       <div class="brands">
       	<div class="m_3"><span class="left_line"> </span><h3>Our Brands</h3><span class="right_line"> </span></div>
       	<div class="container">
       		<ul class="brands_list">
       		  ...
       		  <li class="brand_last"><img src="images/br5.jpg" class="img-responsive" alt=""/></li>
       		  <div class="clearfix"> </div>
       		</ul>
       	</div>
       </div>
